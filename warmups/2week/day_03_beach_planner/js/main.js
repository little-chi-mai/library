...
//     beachPlanner: function (preferTemp, preferRain) {
//         let beachDays = [];
    
//         this.forecast.forEach(dayObj => {
//             if (preferTemp <= dayObj.temp && preferRain >= dayObj.rain) {
//                 beachDays.push(dayObj.day);
//             }
//         })
...
// console.log(beachPlanner1.beachPlanner(24, 8));
// console.log(beachPlanner1.beachPlanner(20, 15));
